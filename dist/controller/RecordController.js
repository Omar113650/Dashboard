"use strict";
const { RecordActivity, validateCreateActivity, } = require("../models/RecordActivity");
...
module.exports.UpdateRecordActivity = asyncHandler(async (req, res) => {
    ...
    const updatedRecord = await RecordActivity.findByIdAndUpdate(recordId, { $set: updatedData }, { new: true, runValidators: true });
    res.status(200).json({
